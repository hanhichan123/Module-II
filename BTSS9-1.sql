...
-- Tạo VIEW EmployeeBranch
-- Tạo một VIEW có tên EmployeeBranch để hiển thị thông tin chi tiết của nhân viên cùng với chi nhánh họ làm việc.
-- VIEW này sẽ kết hợp dữ liệu từ bảng Employees và Branch.
